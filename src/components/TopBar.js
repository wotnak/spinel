...
const TopBar = props => {
  return (
    <div className="topbar container">
      <div className="info">
        <div className="hours">
          <FontAwesomeIcon icon={faClock} height="12" width="12" /> pon-pt 7:00 - 15:00 <span style="color:#e21c2a;font-weight:bold;margin-left:3px;">(od 23.12 do 01.01 nieczynne - inwenteryzacja)</span>
        </div>
